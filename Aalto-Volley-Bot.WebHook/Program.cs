...
var webHostConfiguration = builder.Configuration.GetSection(WebHostConfiguration.Configuration).Get<WebHostConfiguration>();
var port = Environment.GetEnvironmentVariable("PORT") ?? "8443";
builder.WebHost.UseUrls($"{webHostConfiguration.Address}:{port}");
...
#pragma warning restore CA1050 // Declare types in namespaces
{
    public static readonly string Configuration = "WebHost";
